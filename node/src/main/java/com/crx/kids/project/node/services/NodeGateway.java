...
import com.crx.kids.project.node.entities.KeyValue;
...
public class NodeGateway {
    ...
    public Result send(String payload, NodeInfo nextHop, String path, KeyValue<String, String>...headers) {
        ...
        try {
            ...
            Stream.of(headers).forEach(h -> httpHeaders.add(h.getKey(), h.getValue()));
